...
export default function Home() {
  ...
  return (
    <div className="w-screen h-[59px]  flex justify-center items-center table-fixed ">
      <div className="w-[1280px] h-[36px]  flex justify-between items-center table-fixed">
        <div className="w-[92px] h-[20px] ">
          <img src="/img/Logo.png" alt="" />
        </div>
        <div className="w-[488px] h-[36px]  flex justify-between items-center">
          <Select>
